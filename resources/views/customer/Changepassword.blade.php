						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="form-body">
										<form v-on:submit.prevent="changepassword()" id="formdata" class="row g-3">

											<div class="col-12">
												<label class="form-label">Current Password</label>
												<input name="currentpw" type="text" class="form-control" placeholder="Nhập vào mật khẩu hiện tại">
											</div>
											<div class="col-md-6">
                                                <label class="form-label">New Password</label>
												<input name="newpw" type="text" class="form-control" placeholder="Nhập vào mật khẩu mới">
											</div>
                                            <div class="col-md-6">
                                                <label class="form-label">confirm Password</label>
												<input name="confirmpw" type="text" class="form-control" placeholder="Nhập lại mật khẩu mới">
											</div>

                                            <div class="col-4 mt-5">
												<div class="d-grid">
                                                    <a href="/" role="button" class="btn btn-danger"><i class="bx bxs-home"></i>back home</a>
												</div>
											</div>
                                            <div class="col-4"></div>
											<div class="col-4 mt-5">
